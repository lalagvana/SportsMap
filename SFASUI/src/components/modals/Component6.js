    ...
    <>
      <div className={styles.div}>
        ...
        <div className={styles.cInputDiv16}>
          ...
          <img className={styles.iconEnd16} alt="" src="../iconend18.svg" />
        </div>
        ...
        <div className={styles.cInputDiv19}>
          <img className={styles.iconStart} alt="" src="../iconstart48.svg" />
          <div className={styles.caretDiv} />
          <div className={styles.textDiv}>Выберите</div>
          <img className={styles.iconEnd16} alt="" src="../iconend18.svg" />
        </div>
        ...
        <img className={styles.togglerIcon} alt="" src="../toggler3.svg" />
        <div className={styles.documentDiv}>
          ...
          <img className={styles.addPadding} alt="" src="../closepadding.svg" />
        </div>
      </div>
      {isFrameOpen && (
        <PortalPopup
