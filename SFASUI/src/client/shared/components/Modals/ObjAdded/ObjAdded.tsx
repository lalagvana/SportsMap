...
export const ObjAdded = ({ onClose }: ModalProps) => {
    return (
            ...
            <div className={styles.successDiv}>
                ...
                <div className={styles.textButtonDiv}>
                    <div className={styles.textDiv}>
                        ...
                        <div className={styles.expositoryTextDiv}>Объект успешно добавлен</div>
                    </div>
                    <div className={styles.buttonDiv} onClick={onClose}>
                        <div className={styles.buttonDiv1}>Окей</div>
                    </div>
                </div>
                <Image className={styles.modalImageIcon} alt="" src="../modal-image2.svg" />
            </div>
        </div>
    );
};
