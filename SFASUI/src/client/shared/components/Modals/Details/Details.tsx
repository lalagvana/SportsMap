...
export const Details = ({ onClose }: ModalProps) => {
    return (
        <div className={styles.detailsDiv}>
            <div className={styles.detailsDiv1}>
                <Image className={styles.icArrowsLeftIcon} alt="" src="../icarrowsleft.svg" onClick={onClose} />
                ...
                <div className={styles.labelDiv2}>Адрес: Выборгская набережная, д. 1, корп.1, лит. А-БВГД</div>
                <div className={styles.labelDiv3}>Номер телефона: +7 (923) 1234 - 123</div>
                <div className={styles.labelDiv4}>
                    <span className={styles.labelTxtSpan}>
                        <span>{`Сайт: `}</span>
                        <span className={styles.httpsfitnessHouseruSpan}>https://fitness-house.ru</span>
                    </span>
                </div>
                ...
                <Image className={styles.togglerIcon} alt="" src="../toggler2.svg" />
            </div>
        </div>
    );
};
