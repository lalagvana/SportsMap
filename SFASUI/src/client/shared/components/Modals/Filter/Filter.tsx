...
export const Filter = ({ onClose }: ModalProps) => {
    return (
        <div className={styles.filterDiv}>
            <div className={styles.filterDiv1}>
                ...
                <div className={styles.cInputDiv1}>
                    ...
                    <Image className={styles.iconEnd1} alt="" src="../iconend18.svg" />
                </div>
                <div className={styles.groupDiv}>
                    <div className={styles.labelDiv2}>Форма собственности</div>
                    <div className={styles.cInputDiv2}>
                        <Image className={styles.iconStart} alt="" src="../iconstart23.svg" />
                        <div className={styles.caretDiv} />
                ...
                <div className={styles.groupDiv1}>
                    ...
                    <div className={styles.cInputDiv4}>
                        <Image className={styles.iconStart} alt="" src="../iconstart25.svg" />
                        <div className={styles.caretDiv} />
                        <div className={styles.textDiv}>Выберите</div>
                        <Image className={styles.iconEnd1} alt="" src="../iconend21.svg" />
                    </div>
                </div>
                <div className={styles.groupDiv2}>
                    ...
                    <Image className={styles.togglerIcon} alt="" src="../toggler1.svg" />
                </div>
            </div>
        </div>
    );
