...
export const Email = ({ onClose }: ModalProps) => {
    ...
    return (
        <>
                ...
                <div className={styles.emailDiv1}>
                    ...
                    <div className={styles.inputStandardDiv}>
                        <div className={styles.inputDiv}>
                            ...
                            <div className={styles.cInputDiv}>
                                <Image className={styles.iconStart} alt="" src="../iconstart26.svg" />
                    ...
                    <div className={styles.inputStandardDiv1}>
                        <div className={styles.inputDiv}>
                            ...
                            <div className={styles.cInputDiv}>
                                <Image className={styles.iconStart} alt="" src="../iconstart27.svg" />
                                <div className={styles.caretDiv} />
                                <div className={styles.textDiv}>Введите адрес электронной почты или номер телефона</div>
                                <Image className={styles.iconEnd} alt="" src="../iconend.svg" />
                            </div>
                            <div className={styles.lMessageDiv}>
                                <Image className={styles.iconMessage} alt="" src="../iconmessage7.svg" />
                    ...
                    <div className={styles.inputStandardDiv2}>
                        <div className={styles.inputDiv}>
                            <div className={styles.lLabelDiv1}>
                                <div className={styles.labelDiv}>Введите ваше замечание или предложение</div>
                                <div className={styles.hintDiv1}>Optional Hint</div>
                            </div>
                            <div className={styles.cInputDiv2}>
                                <Image className={styles.iconStart} alt="" src="../iconstart28.svg" />
                                <div className={styles.caretDiv} />
                                <div className={styles.textDiv}>Введите текст</div>
                                <Image className={styles.iconEnd} alt="" src="../iconend.svg" />
                            </div>
                            <div className={styles.lMessageDiv}>
                                <Image className={styles.iconMessage} alt="" src="../iconmessage20.svg" />
                                <div className={styles.messageDiv}>Optional Message</div>
                            </div>
                        </div>
                    </div>
                    <textarea className={styles.cInputTextarea} placeholder="Введите текст" required />
            ...
            {isSuccessOpen && (
                <PortalPopup overlayColor="rgba(113, 113, 113, 0.3)" placement="Centered" onOutsideClick={closeSuccess}>
